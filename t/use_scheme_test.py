...
expected = iter([ {"flags":21,"mask":"/use_scheme/11/*"},
                  {"flags":21,"mask":"/use_scheme/10/*"},
                  {"flags":21,"mask":"/use_scheme/12/*"}
                  ])
for r in json.loads(res):
    e = next(expected)
# This comment solves issue with non sorted responses
#    print(e, r)
